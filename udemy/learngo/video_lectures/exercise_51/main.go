...
func main() {
	...
	//add more records to the map
	am["Bob Builder"] = []string{`construction hat`, `mustache`, `crane`}
	am["Dr. Suess"] = []string{`the cat in the hat`, `green eggs and ham`, `I am not going to get up today`}
	...
	fmt.Println("Here is the map before deleting\n", am)

	delete(am, "Q")

	fmt.Println("Here is the map after deleting\n", am)
